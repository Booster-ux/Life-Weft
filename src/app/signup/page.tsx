...
function SignupFormContent() {
    ...
    // Pure Password Signup (NO OTP, NO Confirmation Links)
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // 2. If session is immediately returned, proceed directly to dashboard
            if (data.session) {
            ...
            // 3. If project returns user without session, immediately authenticate with the password
            ...
            if (signInError) {
                // If Supabase has email confirmation enforced in project settings
                if (signInError.message.toLowerCase().includes("email not confirmed")) {
                    setError("Account created! In your Supabase Dashboard, please toggle 'Confirm email' to OFF for instant signup without confirmation.");
                } else {
        ...
        try {
            ...
            if (oauthError) {
                if (
                    ...
                    setError("Google sign-in is currently pending activation in your Supabase dashboard. Please create an account with email and password.");
                } else {
            ...
            <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10">
                ...
                <div className="text-center">
                    ...
                    <p className="mt-2 text-xs sm:text-sm text-brand-muted">
                        Join Lifeweft for free. Instant setup, no email confirmation required.
                    </p>
                </div>
            </div>
